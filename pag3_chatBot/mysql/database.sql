...
INSERT INTO `pregunta` VALUES (0,'¿Cual es el nombre completo de la empresa?',0,0),(1,'¿Què significa Naatik?',1,0),(2,'¿Còmo se fundò la empresa Naatik?',2,0),(3,'¿Cuàndo comenzaron las operaciones?',3,0),(4,'¿Tiene Naatik RFC y Reniecyt?',4,1),(5,'¿Cuàles son las principales lìneas del negocio?',5,1),(6,'¿Cuàl es la principal lìnea de negocios de Naatik?',6,1),(7,'¿Què problemas puede resolver Naatik en las empresas o industrias?',7,2),(8,'¿Què tipo de soluciones me ofrece la inteligencia artificial?',8,2),(9,'¿Còmo funciona la vinculaciòn Industria / Academia?',9,4),(10,'¿Quiènes son los socios principales?',10,3),(11,'¿Ademàs de los socios, tienen algunos otros colaboradores?',11,3),(12,'¿Tienen empresas hermanas y cuàles son?',12,3),(13,'¿Con cuales otras instituciones tiene Naatik relaciones de negocios?',13,3),(14,'¿Què opciones se ofrecen para estudiantes?',14,4);
...
-- Dump completed on 2022-05-05 16:34:29
